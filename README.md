...
* _browser_: A browser environment, defined by an environment that is not Node.js or a fork of Node.js, with the presence of the `document` global (specifically, Electron is not a browser).
